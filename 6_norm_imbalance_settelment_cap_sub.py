...
# uv run 6_norm_imbalance_settelment_cap_sub.py
...
output_folder = "C:\\Users\\ScheiblS\\Documents\\Repositories\\dyn-grid-tariffs\\results\\a_combined_results_cap_sub"
...
models = ["Base", "TOU", "MPD", "MPD-50", "MPD-50-inc", "MPD-50-inc-4kW", "Cap. sub. 7.5kW",
    "Cap. sub. 4kW"]
group_colors = {
    "FCG1": "blue", "FCG2": "green", "FCG3": "purple",
    "FCG4": "orange", "FCG5": "cyan", "IFCG": "magenta"
...
output_folder = "results/a_combined_results_cap_sub/"
os.makedirs(output_folder, exist_ok=True)
...
pdf_file_path = "C:\\Users\\ScheiblS\\Documents\\Repositories\\dyn-grid-tariffs\\results\\a_combined_results_cap_sub\\a_imbalance_scatter.pdf"
fig.write_image(pdf_file_path, format='pdf')
print(f"Scatterplot has been saved as '{pdf_file_path}'")

html_file_path = "C:\\Users\\ScheiblS\\Documents\\Repositories\\dyn-grid-tariffs\\results\\a_combined_results_cap_sub\\a_imbalance_scatter.html"
fig.write_html(html_file_path)
